"""Standalone Adaptive Memory MCP client.
...
CLIENT_NAME = "rakesh-adaptive-memory-skill"
...
ALIAS = 'adaptive_memory'
ENDPOINT = 'https://adaptivememory.zeabur.app/mcp'
PRIMARY_TOKEN_ENV = 'ADAPTIVE_MEMORY_TOKEN'
...
def _build_parser():
    parser = argparse.ArgumentParser(description="Adaptive Memory MCP client (adaptive_memory)")
