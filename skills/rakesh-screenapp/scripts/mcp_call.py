"""Standalone ScreenApp MCP client.
...
CLIENT_NAME = "rakesh-screenapp-skill"
...
def _disk_store(payload):
    ...
    try:
        ...
        pass  # cache is best-effort; a write failure can never fail the call
...
ALIAS = 'screenapp'
ENDPOINT = 'https://screenapp-mcp.zeabur.app/mcp'
PRIMARY_TOKEN_ENV = 'SCREENAPP_TOKEN'
FALLBACK_TOKEN_ENV = 'SCREENAPP_API_TOKEN'


def _token():
    value = os.environ.get(PRIMARY_TOKEN_ENV) or os.environ.get(FALLBACK_TOKEN_ENV) or ""
    return value or None


def _build_parser():
    parser = argparse.ArgumentParser(description="ScreenApp MCP client (screenapp)")
