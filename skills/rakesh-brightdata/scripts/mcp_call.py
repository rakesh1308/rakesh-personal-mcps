"""Standalone Bright Data MCP client.
...
ALIAS = 'brightdata'
ENDPOINT = 'https://brightdata-mcp-server.zeabur.app/mcp'
PRIMARY_TOKEN_ENV = 'BRIGHTDATA_MCP_TOKEN'
...
def _build_parser():
    parser = argparse.ArgumentParser(description="Bright Data MCP client (brightdata)")
