...
ALIAS = 'google'
ENDPOINT = 'https://google-mcp.zeabur.app/mcp'
PRIMARY_TOKEN_ENV = 'GOOGLE_MCP_TOKEN'
...
def _build_parser():
    parser = argparse.ArgumentParser(description="Google MCP client (google)")
